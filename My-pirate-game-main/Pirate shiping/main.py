...
# טעינת תמונות
RED_MONSTER = pygame.image.load(os.path.join(
    'assests', 'pixel_ship_red_small.png'))
GREEN_MONSTER = pygame.image.load(os.path.join(
    'assests', 'pixel_ship_green_small.png'))
BLUE_MONSTER = pygame.image.load(os.path.join(
    'assests', 'pixel_ship_blue_small.png'))

# שחקן
YELLOW_SPACE_SHIP = pygame.image.load(
    os.path.join('assests', 'pixel_ship_yellow.png'))
...
BG = pygame.transform.scale(pygame.image.load(os.path.join(
    'assests', 'background-black.png')), (WIDTH, HEIGHT))
        ...
        if len(enemies) == 0:
            ...
            for i in range(wave_length):
                enemy = Enemy(random.randrange(50, WIDTH-100), random.randrange(-1500 *
                              level/5, -100), random.choice(['red', 'green', 'blue']))
